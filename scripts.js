...
var caption = [
	alternate[0].concat("<br><strong>Small image editor with many features<br>Language: Python</strong><br><br>" +
						"&bull; Custom designed selection box function<br>" +
						"&bull; Works with many image formats including JPEG, PNG, BMP<br>" +
						...
						"&bull; Algorithms for effects like auto contrast, blur, equalize, flip, invert, sharpen, smooth, emboss, contour, red eye reduction, greyscale<br><br>" +
						"GitHub Link: <strong><a href=\"https://github.com/jmashuque/jawad-grimp.github.io\">Click Here</a></strong>"),
	alternate[1].concat("<br><strong>Puzzle game using tiles and sprites<br>Language: Java</strong><br><br>" +
						...
						"&bull; Uses arraylist to hold level and player grid data<br><br>" +
						"GitHub Link: <strong><a href=\"https://github.com/jmashuque/jawad-sokoban.github.io\">Click Here</a></strong><br>"),
	alternate[2].concat("<br><strong>Website using Heroku and MongoDB <br>Languages: JavaScript, Node.js</strong><br><br>" +
						...
						"&bull; Includes npm modules such as fs, path, client-sessions, body-parser<br><br>" +
						"GitHub Link: <strong><a href=\"https://github.com/jmashuque/jawad-bank.github.io\">Click Here</a></strong><br>" +
					   	"Website on Heroku: <strong><a href=\"http://jawad-mashuque-assi3.herokuapp.com\">Click Here</a></strong><br>" +
					   	"username: \"john@beatles.uk\"<br>password: \"lennonj!\""),
	alternate[3].concat("<br><strong>Android app to store Addresses<br>Languages: Java Android, XML</strong><br><br>" +
						...
						"&bull; Uses activity, fragment activity, toast, spinners, and a linear layout<br><br>" +
						"GitHub Link: <strong><a href=\"https://github.com/jmashuque/jawad-address.github.io\">Click Here</a></strong>")
]
